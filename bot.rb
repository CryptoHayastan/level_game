  ...
  bot.listen do |update|
    begin
      ...
      when Telegram::Bot::Types::Message
        ...
        when '/kap'
          excluded_links = %w[Enigmayvn KhalifastoryYVN HighKap Rick_Yerevan Diktatooooor PABL0NA PirateYVN AyLmolorakayinYVN]
        ...
        when /^\/whois (.+)/
          query = update.text.gsub('/whois ', '').strip

          target_user = User.where(
            "first_name ILIKE :q OR last_name ILIKE :q OR username ILIKE :q OR CAST(telegram_id AS TEXT) = :raw_q",
            q: query, raw_q: query
          ).first
      ...
      when Telegram::Bot::Types::CallbackQuery
        ...
        when /^bonus_(\d+)$/
          ...
          price = bonus_prices[discount]
            ...
            Խնդրում ենք գրել @LokiiYvn և սպասել։
